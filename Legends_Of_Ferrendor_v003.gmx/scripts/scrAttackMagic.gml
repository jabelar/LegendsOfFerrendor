...
if willAttack
{
    switch (moveDirection)
    {
        case MAGIC_LEFT:
        {
            objInstance = instance_create(objPlayer.x - TILE_SIZE + TILE_SIZE / 2, objPlayer.y + TILE_SIZE / 2, objMagic);
        ...
        case MAGIC_UP:
        {
            objInstance = instance_create(objPlayer.x + TILE_SIZE / 2, objPlayer.y - TILE_SIZE + TILE_SIZE / 2, objMagic);
