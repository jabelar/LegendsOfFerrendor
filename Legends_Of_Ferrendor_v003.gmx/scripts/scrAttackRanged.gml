...
if willAttack
{
    switch (moveDirection)
    {
        case RANGED_LEFT:
        {
            objInstance = instance_create(objPlayer.x - TILE_SIZE + TILE_SIZE / 2, objPlayer.y + TILE_SIZE / 2, objRanged);
        ...
        case RANGED_UP:
        {
            objInstance = instance_create(objPlayer.x + TILE_SIZE / 2, objPlayer.y - TILE_SIZE + TILE_SIZE / 2, objRanged);
